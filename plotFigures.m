...
data2 = load("data/data_gridRefinedXSM025ISSM Shift6bedmap0.mat");
% [uu,vv] = measures_interp('velocity',data2.xy(:,1),data2.xy(:,2));
% data2.u = uu/3.154E7;
% data2.v = vv/3.154E7;
for j = 1:numel(cases)
    if(isfile("data/data_gridRefinedXSM025ISSM Shift6bedmap"+cases(j)+".mat"))
        data1 = load("data/data_gridRefinedXSM025ISSM Shift6bedmap"+cases(j)+".mat");    
        ax1 = nexttile(j);  
